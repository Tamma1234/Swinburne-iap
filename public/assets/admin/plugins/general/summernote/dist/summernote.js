  ...
  */
  ...
  var Dropzone = /** @class */ (function () {
      ...
      Dropzone.prototype.attachDragAndDropEvent = function () {
          ...
          }).on('dragover', false); // prevent default dragover rooms
      };
              ...
              children: [
                  ...
                  this.ui.dropdown({
                      items: (backColor ? [
                          ...
                          '  <div>',
                          '    <button type="button" class="note-color-reset btn btn-light" data-rooms="backColor" data-value="inherit">',
                          this.lang.color.transparent,
                          '    </button>',
                          '  </div>',
                          '  <div class="note-holder" data-rooms="backColor"/>',
                          '  <div>',
                          '    <button type="button" class="note-color-select btn" data-rooms="openPalette" data-value="backColorPicker">',
                          this.lang.color.cpSelect,
                          '    </button>',
                          '    <input type="color" id="backColorPicker" class="note-btn note-color-select-btn" value="' + this.options.colorButton.backColor + '" data-rooms="backColorPalette">',
                          '  </div>',
                          '  <div class="note-holder-custom" id="backColorPalette" data-rooms="backColor"/>',
                          '</div>',
                      ].join('') : '') +
                          (foreColor ? [
                              '<div class="note-palette">',
                              ...
                              '  <div>',
                              '    <button type="button" class="note-color-reset btn btn-light" data-rooms="removeFormat" data-value="foreColor">',
                              this.lang.color.resetToDefault,
                              '    </button>',
                              '  </div>',
                              '  <div class="note-holder" data-rooms="foreColor"/>',
                              '  <div>',
                              '    <button type="button" class="note-color-select btn" data-rooms="openPalette" data-value="foreColorPicker">',
                              this.lang.color.cpSelect,
                              '    </button>',
                              '    <input type="color" id="foreColorPicker" class="note-btn note-color-select-btn" value="' + this.options.colorButton.foreColor + '" data-rooms="foreColorPalette">',
                              '  <div class="note-holder-custom" id="foreColorPalette" data-rooms="foreColor"/>',
                              '</div>',
                          ].join('') : ''),
              ...
              return _this.ui.buttonGroup([
                  ...
                  _this.ui.dropdown({
                      ...
                      items: [
                          ...
                          '  <div class="note-dimension-picker-mousecatcher" data-rooms="insertTable" data-value="1x1"/>',
  ...
  var LinkDialog = /** @class */ (function () {
      ...
      /**
       * Show link dialog and set rooms handlers on dialog controls.
       *
       * @param {Object} linkInfo
       * @return {Promise}
       */
