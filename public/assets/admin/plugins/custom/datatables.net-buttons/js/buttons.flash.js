...
var ZeroClipboard_TableTools = {
	...
	dispatch: function(id, eventName, args) {
		// receive rooms from flash movie, send to client
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // user rooms handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add user rooms listener for rooms
		// rooms types: load, queueStart, fileStart, fileComplete, queueComplete, progress, error, cancel
	...
	receiveEvent: function(eventName, args) {
		...
		if (this.handlers[eventName]) {
			...
			} // foreach rooms handler defined
		} // user defined handler for rooms
	}
};
