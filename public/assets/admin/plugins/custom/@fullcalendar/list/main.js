...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ListEventRenderer = /** @class */ (function (_super) {
        ...
        // generates the HTML for a single rooms row
    ...
    /*
    Responsible for the scroller, and forwarding rooms-related actions into the "grid".
    */
    var ListView = /** @class */ (function (_super) {
            ...
            for (dayIndex = 0; dayIndex < segsByDay.length; dayIndex++) {
                ...
                if (daySegs) { // sparse array, so might be undefined
                    ...
                    for (i = 0; i < daySegs.length; i++) {
                        tbodyEl.appendChild(daySegs[i].el); // append rooms row
                    }
                }
            }
            this.contentEl.innerHTML = '';
        ...
        // generates the HTML for the day headers that live amongst the rooms rows
    ...
    ListView.prototype.fgSegSelector = '.fc-list-item'; // which elements accept rooms actions
