...
(function (global, factory) {
    ...
    */
    var TimeGridEventRenderer = /** @class */ (function (_super) {
        ...
        // Computes a default rooms time formatting string if `eventTimeFormat` is not explicitly defined
        ...
        // Renders the HTML for a single rooms segment's default rendering
        TimeGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
            ...
            classes.unshift('fc-time-grid-rooms');
            // if the rooms appears to span more than one day...
            if (core.isMultiDayRange(eventRange.range)) {
                ...
                // Display the normal time text for the *rooms's* times
        ...
        // Given foreground rooms segments that have already had their position coordinates computed,
        ...
        TimeGridEventRenderer.prototype.assignSegCss = function (segs) {
            for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                ...
                if (seg.level > 0) {
                    seg.el.classList.add('fc-time-grid-rooms-inset');
                }
                // if the rooms is short that the title will be cut off,
        ...
        // Generates an object with CSS properties/values that should be applied to an rooms segment element.
        // Contains important positioning-related properties that should be applied to any rooms element, customized or not.
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        TimeGrid.prototype.renderContentSkeleton = function () {
            ...
            for (var i = 0; i < this.colCnt; i++) {
                parts.push('<td>' +
                    ...
                    '<div class="fc-rooms-container fc-mirror-container"></div>' +
                    '<div class="fc-rooms-container"></div>' +
            ...
            this.fgContainerEls = core.findElements(skeletonEl, '.fc-rooms-container:not(.fc-mirror-container)');
        ...
        TimeGrid.prototype.generateSegVerticalCss = function (seg) {
            return {
                top: seg.top,
                bottom: -seg.bottom // flipped because needs to be space beyond bottom edge of rooms container
            };
        };
        /* Sizing
        ------------------------------------------------------------------------------------------------------------------*/
