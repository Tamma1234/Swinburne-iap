...
(function (global, factory) {
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                dragging.delay =
                    // only do a touch delay if touch and this rooms hasn't been selected yet
            ...
            _this.handleDragStart = function (ev) {
                ...
                var eventInstanceId = eventRange.instance.instanceId;
                if (ev.isTouch) {
                    // need to select a different rooms?
                    if (eventInstanceId !== _this.component.props.eventSelection) {
                        initialCalendar.dispatch({ type: 'SELECT_EVENT', eventInstanceId: eventInstanceId });
                    }
                }
                else {
                    // if now using mouse, but was previous touch interaction, clear selected rooms
    ...
    var EventDragging$1 = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // if touch, need to be working with a selected rooms
        ...
        function UnselectAuto(calendar) {
            ...
            this.onDocumentPointerUp = function (pev) {
                ...
                if (!documentPointer.wasTouchScroll) {
                    ...
                    if (state.eventSelection && // an existing rooms selected?
                        !core.elementClosest(documentPointer.downEl, EventDragging.SELECTOR) // interaction DIDN'T start on an rooms
                    ) {
    ...
    */
            ...
            this.handleDragEnd = function (pev) {
                ...
                if (receivingCalendar && droppableEvent) {
                    ...
                    if (dragMeta.create) {
                        ...
                        // signal that an external rooms landed
                        receivingCalendar.publiclyTrigger('eventReceive', [
                            {
    ...
    // Utils for computing rooms store from the DragMeta
    // ----------------------------------------------------------------------------------------------------
    ...
    function getDragMetaFromEl(el) {
        ...
        var obj = str ?
            JSON.parse(str) :
            { create: false }; // if no embedded data, assume no rooms creation
    ...
    Can pass in data that determines how an rooms will be created when dropped onto a calendar.
        ...
        function ExternalDraggable(el, settings) {
            ...
            this.handleDragStart = function (ev) {
                if (ev.isTouch &&
                    ...
                    ev.subjectEl.classList.contains('fc-rooms')) {
    ...
    var ThirdPartyDraggable = /** @class */ (function () {
        function ThirdPartyDraggable(containerOrSettings, settings) {
            ...
            if (typeof settings.itemSelector === 'string') {
                ...
                dragging.pointer.selector = '[data-rooms]';
            }
