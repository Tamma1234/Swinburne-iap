...
var KTApp = function () {
    ...
    return {
        init: function (e) {
            ...
            var a, n = $(t), i = '<div class="kt-spinner ' + ((e = $.extend(!0, {
                opacity: .05,
                overlayColor: "#000000",
                type: "",
                size: "",
...
var KTDialog = function (t) {
    var e, a = this, n = KTUtil.get("body"),
        ...
        var o = {
            ...
            construct: function (t) {
                ...
                if (a.options.tooltips) {
                    ...
                    if (o) {
                        var l = e ? "bottom" : "top", r = new Tooltip(o, {
            ...
            if (t.dispatchEvent) {
                ...
                switch (e) {
                    ...
                    case"select":
                        ...
                        break;
                    default:
                        throw"fireEvent: Couldn't find an rooms class for rooms '" + e + "'."
                }
                var i = "change" != e;
...
var KTWizard = function (t, e) {
    ...
    KTUtil.get("body");
    if (n) {
        var i = {startStep: 1, clickableSteps: !0}, o = {
            construct: function (t) {
                ...
                KTUtil.addEvent(a.btnNext, "click", function (t) {
                    ...
                    t.preventDefault(), o.goTo(1, !0)
                }), KTUtil.addEvent(a.btnLast, "click", function (t) {
                    t.preventDefault(), o.goTo(a.totalSteps, !0)
                ...
                if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
                    var n;
                    if (t = t ? parseInt(t) : o.getNextStep(), !0 === e && (n = t > a.currentStep ? o.eventTrigger("beforeNext") : o.eventTrigger("beforePrev")), !0 !== a.stopped) return !1 !== n && (!0 === e && o.eventTrigger("beforeChange"), a.currentStep = t, o.updateUI(), !0 === e && o.eventTrigger("change")), !0 === e ? t > a.startStep ? o.eventTrigger("afterNext") : o.eventTrigger("afterPrev") : a.stopped = !0, a;
                    a.stopped = !1
                }
            }, stop: function () {
                a.stopped = !0
                ...
                if (n && n.length > 0) for (var i = 0, l = n.length; i < l; i++) i == e ? KTUtil.attr(n[i], "data-ktwizard-state", "current") : i < e ? KTUtil.attr(n[i], "data-ktwizard-state", "done") : KTUtil.attr(n[i], "data-ktwizard-state", "pending");
                var r = KTUtil.findAll(a.element, '[data-ktwizard-type="step-info"]');
                if (r && r.length > 0) for (i = 0, l = r.length; i < l; i++) i == e ? KTUtil.attr(r[i], "data-ktwizard-state", "current") : KTUtil.removeAttr(r[i], "data-ktwizard-state");
                var s = KTUtil.findAll(a.element, '[data-ktwizard-type="step-content"]');
                if (s && s.length > 0) for (i = 0, l = s.length; i < l; i++) i == e ? KTUtil.attr(s[i], "data-ktwizard-state", "current") : KTUtil.removeAttr(s[i], "data-ktwizard-state")
            ...
            var l = {
                ...
                layoutUpdate: function () {
                    l.setupSubDatatable.call(), l.setupSystemColumn.call(), l.setupHover.call(), void 0 === i.detail && 1 === l.getDepth() && l.lockTable.call(), l.resetScroll(), l.isLocked() || (l.redraw.call(), l.isSubtable() || !0 !== l.getOption("rows.autoHide") || l.autoHide(), t(o.table).find(".kt-datatable__row").css("height", "")), l.columnHide.call(), l.rowEvenOdd.call(), l.sorting.call(), l.scrollbar.call(), l.isInit || (l.dropdownFix(), t(o).trigger("kt-datatable--on-init", {
                        ...
                        options: i
                    }), l.isInit = !0), t(o).trigger("kt-datatable--on-layout-updated", {table: t(o.wrap).attr("id")})
                },
                        ...
                        lockEnabled: !1, init: function () {
                            ...
                            t(o.table).find("thead,tbody,tfoot").each(function () {
                                ...
                                0 === t(this).find(".kt-datatable__lock").length && t(this).ready(function () {
                                    !function (a) {
                                        if (t(a).find(".kt-datatable__lock").length > 0) l.log("Locked container already exist in: ", a); else if (0 !== t(a).find(".kt-datatable__row").length) {
                ...
                adjustLockContainer: function () {
                    ...
                    var e = t(o.tableHead).width(), a = t(o.tableHead).find(".kt-datatable__lock--left").width(),
                ...
                dragResize: function () {
                    ...
                    t(o.tableHead).find(".kt-datatable__cell").mousedown(function (o) {
                        ...
                        if (n) {
                            var r = t(i).index(), s = t(o.tableBody), d = t(i).closest(".kt-datatable__lock");
                            if (d) {
                                var c = t(d).index();
                ...
                initHeight: function () {
                    if (i.layout.height && i.layout.scroll) {
                        var e = t(o.tableHead).find(".kt-datatable__row").outerHeight(),
                            a = t(o.tableFoot).find(".kt-datatable__row").outerHeight(), n = i.layout.height;
                ...
                initScrollbar: function (e, n) {
                    if (e && e.nodeName) if (t(o.tableBody).css("overflow", ""), a.hasClass(e, "ps")) t(e).data("ps").update(); else {
                ...
                dataRender: function (e) {
                    ...
                    var a = function () {
                        ...
                        if (t(o.wrap).removeClass("kt-datatable--error"), i.pagination) if (i.data.serverPaging && "local" !== i.data.type) {
                ...
                paging: function (e, n) {
                    var i = {
                        ...
                        pagingBreakpoint: function () {
                            ...
                            if (0 !== t(e).length) {
                                var n = l.getCurrentPage(), r = t(e).find(".kt-pager-input").closest("li");
                ...
                columnHide: function () {
                    ...
                    t.each(i.columns, function (n, i) {
                        if (void 0 !== i.responsive || void 0 !== i.visible) {
                            var r = i.field, s = t.grep(t(o.table).find(".kt-datatable__cell"), function (e, a) {
                ...
                setupSubDatatable: function () {
                    ...
                    if ("function" == typeof e && !(t(o.table).find(".kt-datatable__subtable").length > 0)) {
                        ...
                        var a = function (a) {
                            a.preventDefault();
                            var n = t(this).closest(".kt-datatable__row"), r = t(n).next(".kt-datatable__row-subtable");
                ...
                autoHide: function () {
                    ...
                    var n = function (e) {
                        e.preventDefault();
                        var a = t(this).closest(".kt-datatable__row"), n = t(a).next();
                        if (t(n).hasClass("kt-datatable__row-detail")) t(this).find("i").removeClass(l.getOption("layout.icons.rowDetail.expand")).addClass(l.getOption("layout.icons.rowDetail.collapse")), t(n).remove(); else {
                ...
                sortColumn: function (e, a, n) {
                    ...
                    var i = t(e).index(), l = t(o.tableBody).find(".kt-datatable__row"),
                        r = t(e).closest(".kt-datatable__lock").index();
                    -1 !== r && (l = t(o.tableBody).find(".kt-datatable__lock:nth-child(" + (r + 1) + ")").find(".kt-datatable__row"));
                    var s = t(l).parent();
                ...
                setActive: function (e) {
                    ...
                    t(e).each(function (e, n) {
                        var i = t(n).closest("tr").addClass("kt-datatable__row--active"), o = t(i).index() + 1;
                ...
                setInactive: function (e) {
                    ...
                    var a = [];
                    t(e).each(function (e, n) {
                        var i = t(n).closest("tr").removeClass("kt-datatable__row--active"), o = t(i).index() + 1;
        ...
        if (e) {
            KTUtil.scrollInit(e, {
                ...
                height: function () {
                    ...
                    var n = KTUtil.find(t, ".kt-chat"), i = KTUtil.find(t, ".kt-portlet > .kt-portlet__head"),
            ...
            var a = function () {
                var e = KTUtil.find(t, ".kt-scroll"), a = KTUtil.find(t, ".kt-chat__messages"),
                ...
                if (0 !== n.value.length) {
                    ...
                    var o,
                        l = '<div class="kt-chat__user"><span class="kt-chat__datetime">Just now</span><a href="#" class="kt-chat__username">Jason Muller</span></a><span class="kt-media kt-media--circle kt-media--sm"><img src="./assets/media/users/100_12.jpg" alt="image"></span></div><div class="kt-chat__text kt-bg-light-brand">' + n.value;
        ...
        init: function () {
            t(KTUtil.getByID("kt_chat_modal")), "keenthemes.com" != encodeURI(window.location.hostname) && "www.keenthemes.com" != encodeURI(window.location.hostname) || setTimeout(function () {
                if (!Cookies.get("kt_app_chat_shown")) {
                    ...
                    Cookies.set("kt_app_chat_shown", 1, {expires: t}), KTUtil.getByID("kt_app_chat_launch_btn").click()
                }
            }, 2e3)
        }, setup: function (e) {
            t(e)
...
var KTDemoPanel = function () {
    ...
    return {
        init: function () {
            t = KTUtil.getByID("kt_demo_panel"), function () {
                e = new KTOffcanvas(t, {
                    overlay: !0,
                ...
                var a = KTUtil.find(t, ".kt-demo-panel__head"), n = KTUtil.find(t, ".kt-demo-panel__body");
                KTUtil.scrollInit(n, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
                ...
                if (!Cookies.get("kt_demo_panel_shown")) {
                    ...
                    Cookies.set("kt_demo_panel_shown", 1, {expires: t}), e.show()
                }
            }, 4e3)
        }
    }
...
var KTLayout = function () {
    var t, e, a, n, i, o, l, r, s = function () {
    ...
    return {
        init: function () {
            ...
            s = KTUtil.get("kt_aside"), KTUtil.get("kt_aside_brand"), d = KTUtil.hasClass(s, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside", i = new KTOffcanvas("kt_aside", {
                ...
                toggleBy: {target: "kt_aside_mobile_toggler", state: "kt-header-mobile__toolbar-toggler--active"}
...
var KTOffcanvasPanel = function () {
    ...
    return {
        init: function () {
            t = KTUtil.get("kt_offcanvas_toolbar_notifications"), e = KTUtil.get("kt_offcanvas_toolbar_quick_actions"), a = KTUtil.get("kt_offcanvas_toolbar_profile"), n = KTUtil.get("kt_offcanvas_toolbar_search"), function () {
                var e = KTUtil.find(t, ".kt-offcanvas-panel__head"), a = KTUtil.find(t, ".kt-offcanvas-panel__body");
                new KTOffcanvas(t, {
                    overlay: !0,
                ...
                var t = KTUtil.find(e, ".kt-offcanvas-panel__head"), a = KTUtil.find(e, ".kt-offcanvas-panel__body");
                new KTOffcanvas(e, {
                    overlay: !0,
                    baseClass: "kt-offcanvas-panel",
                ...
                var t = KTUtil.find(a, ".kt-offcanvas-panel__head"), e = KTUtil.find(a, ".kt-offcanvas-panel__body");
                new KTOffcanvas(a, {
                    overlay: !0,
                    baseClass: "kt-offcanvas-panel",
                ...
                var t = KTUtil.find(n, ".kt-offcanvas-panel__head"),
                    ...
                    a = KTUtil.find(e, ".kt-quick-search__form"), i = KTUtil.find(e, ".kt-quick-search__wrapper");
                new KTOffcanvas(n, {
                    overlay: !0,
                    baseClass: "kt-offcanvas-panel",
...
}, KTQuickSearchInline = KTQuickSearch, KTQuickSearchOffcanvas = KTQuickSearch;
KTUtil.ready(function () {
