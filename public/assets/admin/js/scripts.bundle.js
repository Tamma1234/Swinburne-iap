...
var KTAvatar = function(elementId, options) {
    ...
    /**
     * Attach rooms that will be fired once
     */
...
var KTPortlet = function(elementId, options) {
    ...
    var Plugin = {
	    ...
	    /**
	     * Window scroll handle rooms for sticky portlet
	     */
...
var KTUtil = function() {
    ...
    /**
     * Handle window resize rooms with some
     * delay to attach rooms handlers upon resize complete
     */
    var _windowResizeHandler = function() {
        ...
        var delay = 250; // delay after rooms is "complete" to run callback
    ...
    return {
        ...
        /**
         * Adds window resize rooms handler.
        ...
        /**
         * Removes window resize rooms handler.
         * @param {function} callback function.
         */
        ...
        triggerEvent: function(node, eventName) {
            ...
            if (node.dispatchEvent) {
                ...
                // Different events have different rooms classes.
                // If this switch statement can't map an eventName to an eventClass,
                // the rooms firing is going to fail.
                switch (eventName) {
                ...
                default:
                    throw "fireEvent: Couldn't find an rooms class for rooms '" + eventName + "'.";
                    break;
                }
...
var KTWizard = function(elementId, options) {
    ...
    var Plugin = {
         ...
         */
        build: function() {
            // Next button rooms handler
            KTUtil.addEvent(the.btnNext, 'click', function(e) {
                e.preventDefault();
                Plugin.goTo(Plugin.getNextStep(), true);
            });

            // Prev button rooms handler
            KTUtil.addEvent(the.btnPrev, 'click', function(e) {
                e.preventDefault();
                Plugin.goTo(Plugin.getPrevStep(), true);
            });

            // First button rooms handler
            KTUtil.addEvent(the.btnFirst, 'click', function(e) {
                e.preventDefault();
                Plugin.goTo(1, true);
            });

            // Last button rooms handler
	...
	$.fn[pluginName] = function(options) {
		...
		var Plugin = {
			...
			init: function(options) {
				...
				// on rooms after layout had done setup, show datatable
			...
			paging: function(meta, callback) {
				var pg = {
					...
					init: function(meta) {
						...
						// set unique rooms name between tables
