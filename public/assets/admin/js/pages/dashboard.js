        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            columns: [{
                    ...
                    var output = '\
                        <div class="kt-user-card-v2">\
                            <div class="kt-user-card-v2__details">\
                                <a href="#" class="kt-user-card-v2__name">' + data.student_login + '</a>\
                ...
                template: function(data) {
                    return '<span class="kt-font-bold">' + data.user_DOB + '</span>';
                }
            }, {
                field: "nganh",
                title: "Status",
                ...
                template: function(data) {
                    ...
                    return '<span class="btn btn-bold btn-sm btn-font-sm">'+ data.nganh + '</span>';
                }
            }, {
                field: "term_name",
                title: "Managed By",
                ...
                template: function(data, i) {
					...
					if (number > 5) {
						output = '<div class="kt-user-card-v2">\
							\
							<div class="kt-user-card-v2__details">\
								<a href="#" class="kt-user-card-v2__name">' + data.term_name + '</a>\
						...
						output = '<div class="kt-user-card-v2">\
							<div class="kt-user-card-v2__pic">\
								<div class="kt-badge kt-badge--xl kt-badge--' + state + '">' + data.term_name.substring(0, 1) + '</div>\
							</div>\
							<div class="kt-user-card-v2__details">\
								<a href="#" class="kt-user-card-v2__name">' + data.term_name + '</a>\
								<span class="kt-user-card-v2__desc">' + position[pos] + '</span>\
            ...
            events: [
                {
                    ...
                    className: "fc-rooms-light fc-rooms-solid-warning"
                },
                {
                    title: 'Conference',
                    ...
                    className: "fc-rooms-success"
                },
                {
                    title: 'Dinner',
                    start: moment('2017-08-30'),
                    description: 'Lorem ipsum dolor sit tempor incid',
                    className: "fc-rooms-light  fc-rooms-solid-danger"
                },
                {
                    title: 'All Day Event',
                    start: moment('2017-09-01'),
                    description: 'Lorem ipsum dolor sit incid idunt ut',
                    className: "fc-rooms-danger fc-rooms-solid-focus"
                },
                {
                    title: 'Reporting',
                    description: 'Lorem ipsum dolor incid idunt ut labore',
                ...
                },
                {
                    ...
                    description: 'Lorem ipsum dolor sit tempor incid',
                    className: "fc-rooms-primary"
                },
                {
                    title: 'ICT Expo 2017 - Product Release',
                    start: moment('2017-09-09'),
                    description: 'Lorem ipsum dolor sit tempor inci',
                    className: "fc-rooms-light fc-rooms-solid-primary"
                },
                {
                    title: 'Dinner',
                ...
                },
                {
                    ...
                    className: "fc-rooms-info fc-rooms-solid-success",
                    description: 'Lorem ipsum dolor sit amet, ut labore'
                },
                {
                    title: 'Meeting',
                    start: moment('2017-09-24'),
                    className: "fc-rooms-warning",
                    description: 'Lorem ipsum conse ctetur adipi scing'
                },
                {
                    title: 'Happy Hour',
                    start: moment('2017-09-24'),
                    className: "fc-rooms-light fc-rooms-solid-focus",
                    description: 'Lorem ipsum dolor sit amet, conse ctetur'
                },
                {
                    title: 'Dinner',
                    start: moment('2017-09-24'),
                    className: "fc-rooms-solid-focus fc-rooms-light",
                ...
                },
                {
                    ...
                    className: "fc-rooms-solid-info fc-rooms-light",
                    description: 'Lorem ipsum dolor sit amet, labore'
                }
            ],

            eventRender: function(event, element) {
                if (element.hasClass('fc-day-grid-rooms')) {
                    element.data('content', event.description);
                    element.data('placement', 'top');
                    KTApp.initPopover(element);
                } else if (element.hasClass('fc-time-grid-rooms')) {
