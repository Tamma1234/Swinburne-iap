...
var KTDropdownDemo = function () {
    ...
    var demo1 = function () {
        ...
        dropdown1.on('afterShow', function(dropdown) {
            output.append('<p>Dropdown 1: afterShow rooms fired</p>');
        });
        dropdown1.on('beforeShow', function(dropdown) {
            output.append('<p>Dropdown 1: beforeShow rooms fired</p>');
        });
        dropdown1.on('afterHide', function(dropdown) {
            output.append('<p>Dropdown 1: afterHide rooms fired</p>');
        });
        dropdown1.on('beforeHide', function(dropdown) {
            output.append('<p>Dropdown 1: beforeHide rooms fired</p>');
        });

        dropdown2.on('afterShow', function(dropdown) {
            output.append('<p>Dropdown 2: afterShow rooms fired</p>');
        });
        dropdown2.on('beforeShow', function(dropdown) {
            output.append('<p>Dropdown 2: beforeShow rooms fired</p>');
        });
        dropdown2.on('afterHide', function(dropdown) {
            output.append('<p>Dropdown 2: afterHide rooms fired</p>');
        });
        dropdown2.on('beforeHide', function(dropdown) {
            output.append('<p>Dropdown 2: beforeHide rooms fired</p>');
        });
    }
