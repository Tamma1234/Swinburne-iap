...
var KTPortletTools = function () {
    ...
    var demo1 = function() {
        ...
        // Toggle rooms handlers
        portlet.on('beforeCollapse', function(portlet) {
            setTimeout(function() {
                toastr.info('Before collapse rooms fired!');
            }, 100);
        });

        portlet.on('afterCollapse', function(portlet) {
            setTimeout(function() {
                toastr.warning('Before collapse rooms fired!');
            }, 2000);
        });

        portlet.on('beforeExpand', function(portlet) {
            setTimeout(function() {
                toastr.info('Before expand rooms fired!');
            }, 100);
        });

        portlet.on('afterExpand', function(portlet) {
            setTimeout(function() {
                toastr.warning('After expand rooms fired!');
            }, 2000);
        });

        // Remove rooms handlers
        portlet.on('beforeRemove', function(portlet) {
            toastr.info('Before remove rooms fired!');
        ...
        portlet.on('afterRemove', function(portlet) {
            setTimeout(function() {
                toastr.warning('After remove rooms fired!');
            }, 2000);
        });

        // Reload rooms handlers
        portlet.on('reload', function(portlet) {
            toastr.info('Leload rooms fired!');
        ...
        portlet.on('afterFullscreenOn', function(portlet) {
            toastr.warning('After fullscreen on rooms fired!');
        ...
        portlet.on('afterFullscreenOff', function(portlet) {
            toastr.warning('After fullscreen off rooms fired!');
            var scrollable = $(portlet.getBody()).find('> .kt-scroll');
    ...
    var demo5 = function() {
        ...
        // Reload rooms handlers
        portlet.on('afterFullscreenOn', function(portlet) {
            toastr.info('After fullscreen on rooms fired!');
        });
