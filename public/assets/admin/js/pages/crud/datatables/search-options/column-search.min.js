        ...
        init: function () {
            ...
            t = $("#kt_table_1").DataTable({
                ...
                ajax: {
                    ...
                    type: "POST",
                    data: {columnsDef: ["RecordID", "OrderID", "Country", "ShipCity", "CompanyAgent", "ShipDate", "Status", "Type", "Actions"]}
                },
                columns: [{data: "RecordID"}, {data: "OrderID"}, {data: "Country"}, {data: "ShipCity"}, {data: "CompanyAgent"}, {data: "ShipDate"}, {data: "Status"}, {data: "Type"}, {
                    data: "Actions",
                    responsivePriority: -1
                }],
                initComplete: function () {
                    var e = this, a = $('<tr class="filter"></tr>').appendTo($(t.table().header()));
                ...
                columnDefs: [{
                    targets: -1, title: "Actions", orderable: !1, render: function (t, e, a, n) {
