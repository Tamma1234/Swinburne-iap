...
@section('content')
    @include('admin.templates.content-header', ['name' => 'Swinburne', 'key' => 'Survey',
      'value' => "Create Survey", 'value2' => ""])
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" action="{{route('survey.store')}}"
                          enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="kt-portlet__body" style="height: 1200px">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>Name Survey:</label>
                                        <input type="text" class="form-control" name="name_survey">
                                        @error('name_survey')
                                    ...
                                    <div class="form-group">
                                        <label for="exampleSelectd">Start Date</label>
                                        <input type="date" min="0" class="form-control" name="start_at">
                                        @error('start_at')
                                        <div class="alert alert-solid-danger alert-bold">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12 col-md-12" style="padding-top: 30px">
                                    <div class="form-group form-group-last row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Add Student</label>
                                        <div class="col-lg-12 col-md-9 col-sm-12">
                                            <input id="kt_tagify_1" name='user_login'
                                                   placeholder='Thêm member bằng mã user code'
                                            ...
                                            <div class="kt-margin-t-10">
                                                <a href="javascript:;" id="kt_tagify_1_remove"
                                                   class="btn btn-label-brand btn-bold">Remove
                                                    tags</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-md-12" style="padding-top: 30px">
                                    <div class="card-border-primary form-group">
                                        ...
                                        {{--                                    <select class="form-control kt-selectpicker" multiple data-actions-box="true" name="question_id[]">--}}
                                        {{--                                        @foreach($questions as $item)--}}
                                        {{--                                            <option value="{{ $item->id }}"--}}
                                        {{--                                                    style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width: 1000px;">{{ $item->question }}</option>--}}
                                        {{--                                        @endforeach--}}
                                        {{--                                    </select>--}}
                                        {{--                                </div>--}}
                                        <div class="row" id="modul-row">
                                            <div class="kt-checkbox-list">
                                                <label class="kt-checkbox kt-checkbox--solid kt-checkbox--light">
                                                    <input class="checkbox_wraper custom-control-input" type="checkbox">Questions
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            @foreach($questions as $item)
                                                <div class="form-group col-md-12">
                                                    <div class="kt-checkbox-inline">
                                                        <label
                                                            class="kt-checkbox kt-checkbox--bold kt-checkbox--primary">
                                                            <input type="checkbox" name="question_id[]"
                                                                   class="checkbox_childrent custom-control-input"
                                                                   value="{{$item->id}}">{!! htmlspecialchars_decode($item->name) !!}
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
